...
var nation = document.getElementById('pagination-wrapper')
...
for (var page = maxLeft; page <= maxRight; page++) {
    nation.innerHTML += `<button value=${page} class="page btn btn-sm btn-info">${page}</button>`
}

if (state.page != 1) {
    nation.innerHTML = `<button value=${1} class="page btn btn-sm btn-info">&#171; First</button>` + wrapper.innerHTML
}

if (state.page != pages) {
    nation.innerHTML += `<button value=${pages} class="page btn btn-sm btn-info">Last &#187;</button>`
}
